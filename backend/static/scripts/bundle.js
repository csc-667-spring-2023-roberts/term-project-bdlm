(() => {
  ...
  (s.n = (t) => {
    ...
    (() => {
      ...
      function _(t, e) {
        e.useNativeTimers
          ? ((t.setTimeoutFn = v.bind(m)), (t.clearTimeoutFn = w.bind(m)))
