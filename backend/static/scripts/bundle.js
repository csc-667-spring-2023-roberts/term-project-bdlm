(() => {
  var t = {
      ...
      34: (t) => {
        t.exports = {
          GAMES: {
            PLAYER_JOINED: (t) => `game:${t}:player-joined`,
            GAME_STATE_UPDATED: (t, e) => `game:${t}:${e}:updated`,
          },
        };
      },
      992: (t, e, s) => {
        ...
        const w = v.setTimeout,
          k = v.clearTimeout;
        function E(t, e) {
          e.useNativeTimers
            ? ((t.setTimeoutFn = w.bind(v)), (t.clearTimeoutFn = k.bind(v)))
            : ((t.setTimeoutFn = v.setTimeout.bind(v)),
        ...
        function D(t) {
          ...
          if (!e)
            try {
              return new v[["Active"].concat("Object").join("X")](
                "Microsoft.XMLHTTP"
              );
            } catch (t) {}
        }
        function I() {}
        const M = null != new D({ xdomain: !1 }).responseType;
        class F extends b {
          constructor(t, e) {
            super(),
              E(this, e),
        ...
        const U =
            "function" == typeof Promise && "function" == typeof Promise.resolve
              ...
              : (t, e) => e(t, 0),
          H = v.WebSocket || v.MozWebSocket,
          Y =
            "undefined" != typeof navigator &&
            "string" == typeof navigator.product &&
            "reactnative" === navigator.product.toLowerCase(),
          K = {
            websocket: class extends T {
              constructor(t) {
              ...
              doOpen() {
                ...
                try {
                  this.ws = Y ? new H(t, e, s) : e ? new H(t, e) : new H(t);
                } catch (t) {
        ...
        function et(t) {
          return (
            (G && (t instanceof ArrayBuffer || Q(t))) ||
            (Z && t instanceof Blob) ||
            (tt && t instanceof File)
          );
        }
        function st(t, e) {
          if (!t || "object" != typeof t) return !1;
          if (Array.isArray(t)) {
            for (let e = 0, s = t.length; e < s; e++) if (st(t[e])) return !0;
            return !1;
          }
          if (et(t)) return !0;
          if (
            ...
            return st(t.toJSON(), !0);
          for (const e in t)
            if (Object.prototype.hasOwnProperty.call(t, e) && st(t[e]))
              return !0;
          return !1;
        }
        function nt(t) {
        ...
        function rt(t, e) {
          return (t.data = ot(t.data, e)), delete t.attachments, t;
        }
        function ot(t, e) {
          if (!t) return t;
          ...
          if (Array.isArray(t))
            for (let s = 0; s < t.length; s++) t[s] = ot(t[s], e);
        ...
        class ct {
          ...
          encode(t) {
            return (t.type !== ht.EVENT && t.type !== ht.ACK) || !st(t)
          ...
          encodeAsString(t) {
            let e = "" + t.type;
            return (
              (t.type !== ht.BINARY_EVENT && t.type !== ht.BINARY_ACK) ||
                (e += t.attachments + "-"),
              t.nsp && "/" !== t.nsp && (e += t.nsp + ","),
              null != t.id && (e += t.id),
        ...
        class pt extends b {
          ...
          add(t) {
            ...
            if ("string" == typeof t) {
              ...
              const s = e.type === ht.BINARY_EVENT;
              s || e.type === ht.BINARY_ACK
                ? ((e.type = s ? ht.EVENT : ht.ACK),
                  (this.reconstructor = new ut(e)),
                  0 === e.attachments && super.emitReserved("decoded", e))
                : super.emitReserved("decoded", e);
            } else {
              if (!et(t) && !t.base64) throw new Error("Unknown type: " + t);
              if (!this.reconstructor)
                throw new Error(
        ...
        class ft extends b {
          ...
          emit(t, ...e) {
            ...
            const s = { type: ht.EVENT, data: e, options: {} };
            if (
          ...
          ack(t) {
            ...
            let s = !1;
            return function (...n) {
              s || ((s = !0), e.packet({ type: ht.ACK, id: t, data: n }));
            };
          }
          onack(t) {
          ...
          disconnect() {
            return (
              this.connected && this.packet({ type: ht.DISCONNECT }),
              this.destroy(),
          ...
          socket(t, e) {
            ...
            return (
              s
                ...
                : ((s = new ft(this, t, e)), (this.nsps[t] = s)),
              s
            );
          }
          _destroy(t) {
        ...
        function bt(t, e) {
          ...
          const s = (function (t, e = "", s) {
            ...
            i = s.id,
            r = s.path,
            o = mt[i] && r in mt[i].nsps;
          let a;
          return (
            e.forceNew || e["force new connection"] || !1 === e.multiplex || o
              ? (a = new gt(n, e))
              : (mt[i] || (mt[i] = new gt(n, e)), (a = mt[i])),
            s.query && !e.query && (e.query = s.queryKey),
            a.socket(s.path, e)
          );
        }
        Object.assign(bt, { Manager: gt, Socket: ft, io: bt, connect: bt });
      },
    },
    e = {};
  function s(n) {
  ...
  (s.n = (t) => {
    ...
    (() => {
      ...
      var t = s(992),
        e = s(606),
        n = s.n(e);
      const i = (0, t.ZP)({ query: { path: window.location.pathname } }),
        r = document.querySelector("#messages"),
        o = document.querySelector("#chat-message-template");
      i.on(
        n().CHAT_MESSAGE_RECEIVED,
        ({ table_id: t, username: e, message: s, timestamp: n }) => {
          t.toString() == o.target.value &&
            ((entry.querySelector(".username").innerText = e),
            (entry.querySelector(".message").innerText = s),
            (entry.querySelector(".timestamp").innerText = n),
            r.appendChild(entry));
        }
      ),
        document
    ...
    (() => {
      ...
      var t = s(992),
        e = s(34);
      const n = (0, t.ZP)(),
        i = document.querySelector("#user-template"),
        r = document.querySelector("#users"),
        o = (function (t) {
          const e = t.substring(t.lastIndexOf("/") + 1);
          return "lobby" === e ? 0 : parseInt(e);
        })(document.location.pathname);
      n.on(e.GAMES.PLAYER_JOINED(o), ({ username: t }) => {
        const e = i.content.cloneNode(!0);
        (e.querySelector("span.username").innerText = t), r.appendChild(e);
      }),
        fetch("/authentication/user", { method: "post" })
          .then((t) => t.json())
          .then(({ id: t }) => {
            console.log({ user_id: t }),
              n.on(e.GAMES.GAME_STATE_UPDATED(o, t), async (t) => {
